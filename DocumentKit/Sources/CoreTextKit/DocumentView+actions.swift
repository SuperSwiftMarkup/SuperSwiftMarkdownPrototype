...
import DocumentBehavior

fileprivate typealias DocumentKeyBinding = DocumentBehavior.KeyBinding
fileprivate typealias DocumentShortcut = DocumentBehavior.ShortcutAction

fileprivate let VERBOSE_DEBUG_MODE: Bool = false

extension DocumentView {
    func handleAction(action: DocumentBehavior.ShortcutAction) {
        switch action {
